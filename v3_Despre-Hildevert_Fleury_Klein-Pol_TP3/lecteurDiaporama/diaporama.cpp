...
void Diaporama::charger()
{
    ...
    switch(id) {
      case 0 : // diaporama par défaut
        imageACharger = new ImageDansDiaporama(1, "objet", "", ":/images_Diapo/image/Disney_tapis.gif");
        ajouterImageEnFin(imageACharger);
        break ;//
      case 1 : // diaporama de Pantxika
          imageACharger = new ImageDansDiaporama(3, "personnage", "Pinnochio", ":/images_Diapo/image/Disney_29.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(2, "Blanche Neige", ":/images_Diapo/image/Disney_4.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(4, "personnage", "Alice", ":/images_Diapo/image/Disney_2.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(1, "animal", "Mickey", ":/images_Diapo/image/Disney_19.gif");
          ajouterImageEnFin(imageACharger);
          break ;//
      case 2 : // diaporama de Thierry
          imageACharger = new ImageDansDiaporama(1, "personnage", "Pinnochio", ":/images_Diapo/image/Disney_29.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(2, "personnage", "Blanche Neige", ":/images_Diapo/image/Disney_4.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(3, "personnage", "Alice", ":/images_Diapo/image/Disney_2.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(4, "animal", "Mickey", ":/images_Diapo/image/Disney_19.gif");
          ajouterImageEnFin(imageACharger);
          break ;//
      case 3 : // diaporama de Yann
          imageACharger = new ImageDansDiaporama(2, "personnage", "Pinnochio", ":/images_Diapo/image/Disney_29.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(1, "personnage", "Blanche Neige", ":/images_Diapo/image/Disney_4.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(4, "personnage", "Alice", ":/images_Diapo/image/Disney_2.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(3, "animal", "Mickey", ":/images_Diapo/image/Disney_19.gif");
          ajouterImageEnFin(imageACharger);
          break ;//
      case 4 : // diaporama de Manu
          imageACharger = new ImageDansDiaporama(4, "personnage", "Pinnochio", ":/images_Diapo/image/Disney_29.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(3, "personnage", "Blanche Neige", ":/images_Diapo/image/Disney_4.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(2, "personnage", "Alice", ":/images_Diapo/image/Disney_2.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(1, "animal", "Mickey", ":/images_Diapo/image/Disney_19.gif");
          ajouterImageEnFin(imageACharger);
          break ;//
